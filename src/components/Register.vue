<template>
  <el-container>
    <el-main>
      <el-form :model="registerForm" :rules="rules" ref="registerForm" label-position="left" label-width="0px" class="demo-ruleForm login-container">
        ...
        <el-form-item prop="passConfirm">
          <el-input type="password" v-model="registerForm.passConfirm" auto-complete="off" placeholder="请再次输入密码"></el-input>
        </el-form-item>
        ...
        handleSubmit() {
          this.$refs.registerForm.validate((valid) => {
            if (valid) {
              ...
              this.$http.post('/apis/register', user).then(response => {
