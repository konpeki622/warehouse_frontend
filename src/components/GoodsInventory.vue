      ...
      data() {
        ...
        methods: {
          ...
          getAccountAll: function () {
                ...
                this.$http.get('/apis/account?type=1&' + 'goodsId=' + this.$route.query.id, {headers: {
          ...
          handleSearchByYear() {
            if (this.searchType === '0') {
              ...
              this.listLoading = true;
              let today = new Date();
              let interval = Number(today.getFullYear()) - Number(this.year.getFullYear());
              this.$http.get('/apis/account/graph?type=5&goodsId=' + this.$route.query.id + '&condition=' + interval, {headers: {
                'Content-Type': 'application/json',
                'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          handleSearchBySeason() {
            ...
            this.listLoading = true;
            let today = new Date();
            let intervalYear = Number(today.getFullYear()) - Number(this.year.getFullYear());
            let intervalSeason = Number(today.getMonth())/3 - this.season;
            let interval = intervalYear * 4 + intervalSeason;
            this.$http.get('/apis/account/graph?type=4&goodsId=' + this.$route.query.id + '&condition=' + interval, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          handleSearchByMonth() {
            ...
            this.$http.get('/apis/account/graph?type=3&goodsId=' + this.$route.query.id + '&condition=' + interval, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          searchByWeek(id) {
            this.accountData = [];
            this.listLoading = true;
            this.$http.get('/apis/account/graph?type=2&goods_id=' + id, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          searchYesterday(id) {
            this.accountData = [];
            this.listLoading = true;
            this.$http.get('/apis/account/graph?type=1&goods_id=' + id, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          searchToday(id) {
            this.accountData = [];
            this.listLoading = true;
            this.$http.get('/apis/account/graph?type=0&goods_id=' + id, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
