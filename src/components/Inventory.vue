<template>
  <el-container>
    <el-main>
      ...
      <div>
        <!--新增界面-->
        <el-dialog title="新增信息" :visible.sync="addFormVisible" v-loading="addLoading" style="width: 70%; margin: 0 auto">
...
export default {
  ...
  methods: {
    ...
    submitAdd: function() {
      ...
      let url =
        "/apis/goods/update?material_id=" +
        this.goods.material_id +
        "&area_id=" +
        this.goods.area_id +
        "&update_date=" +
