        ...
        methods: {
          ...
          handleSearchByYear() {
            if (this.searchType === '0') {
              ...
              this.$http.get('/apis/account/graph?type=5&condition=' + interval, {headers: {
                'Content-Type': 'application/json',
                'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          handleSearchBySeason() {
            ...
            this.$http.get('/apis/account/graph?type=4&condition=' + interval, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          handleSearchByMonth() {
            ...
            this.$http.get('/apis/account/graph?type=3&condition=' + interval, {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          searchByWeek() {
            this.accountData = [];
            this.listLoading = true;
            this.$http.get('/apis/account/graph?type=2', {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          searchYesterday() {
            this.accountData = [];
            this.listLoading = true;
            this.$http.get('/apis/account/graph?type=1', {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
          ...
          searchToday() {
            this.accountData = [];
            this.listLoading = true;
            this.$http.get('/apis/account/graph?type=0', {headers: {
              'Content-Type': 'application/json',
              'token': localStorage.getItem("token")
              }}).then(response => {
                if (response.status === 200) {
