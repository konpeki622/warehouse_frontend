  ...
  methods: {
    ...
    handleSearchByYear() {
      if (this.searchType === "0") {
        ...
        this.$http
          .get("/apis/account/graph?type=5&condition=" + interval, {
            headers: {
              "Content-Type": "application/json",
              token: localStorage.getItem("token")
            }
    ...
    handleSearchBySeason() {
      ...
      this.$http
        .get("/apis/account/graph?type=4&condition=" + interval, {
          headers: {
            "Content-Type": "application/json",
            token: localStorage.getItem("token")
          }
    ...
    handleSearchByMonth() {
      ...
      this.$http
        .get("/apis/account/graph?type=3&condition=" + interval, {
          headers: {
            "Content-Type": "application/json",
            token: localStorage.getItem("token")
          }
